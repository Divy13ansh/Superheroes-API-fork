...
class SuperheroFilter(django_filters.FilterSet):
    ...
    power_level_min = django_filters.NumberFilter(
        field_name="power_level", lookup_expr="gte"
    )
    power_level_max = django_filters.NumberFilter(
        field_name="power_level", lookup_expr="lte"
    )
